...
function WeatherInput({ value, onChange, onClick }) {
  return (
    <div style={{ marginTop: '3rem', display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'space-between', height: '6rem', width: 'auto' }}>
      ...
      <input  type="text" value={value} onChange={onChange}  style={{ height:'2.5rem', borderRadius: '1rem', width: '20rem', fontWeight: '700', textTransform:'capitalize', border: '2px solid gray' , padding: '0 1rem', marginBottom: '2rem'}}/>
